...
# Create new index by model name
# INDEX_BY_NAME = pandas.Index(CARS['Car'])

# Preserve item No. index by adding new column
# CARS['Original Index No.'] = CARS.index

# Reindex cars by model name
# CARS.index = INDEX_BY_NAME
